    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-700 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold mb-6">About ShopName</h1>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Your trusted partner in quality products and exceptional service since 2020.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                <p className="text-lg leading-relaxed">
                  Founded in 2020, ShopName began as a small family business with a simple mission: 
                  to provide high-quality products at affordable prices while delivering exceptional 
                  customer service.
                </p>
                <p className="text-lg leading-relaxed">
                  What started as a humble online store has grown into a trusted ecommerce platform 
                ...
                <p className="text-lg leading-relaxed">
                  Today, we continue to expand our product offerings while staying true to our core 
                  values of integrity, innovation, and putting our customers first.
                </p>
              </div>
            </div>
            <div className="bg-gray-100 rounded-lg p-8 text-center h-64 flex items-center justify-center">
              <div className="text-gray-400">
                ...
                <p className="text-lg">Our Journey Since 2020</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                To make quality products accessible to everyone by providing exceptional value, 
                transparent pricing, and outstanding customer service. We believe that everyone 
                deserves access to well-made, reliable products without breaking the bank.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                To become the most trusted and customer-centric online marketplace, where people 
                can discover and purchase products they love with complete confidence and peace of mind.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Our customers are at the heart of everything we do. We listen, we learn, and we 
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                We believe in transparency and honesty. What you see is what you get, with no 
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Why Choose ShopName?</h2>
